...
//        });
    ...
    private class GetGalleries extends AsyncTask<Void, Void, Void> {
        ...
        protected Void doInBackground(Void... arg0) {
            ...
            String url = "https://nowtoronto.com/api/search/location/restaurants/get_search_results";
            ...
            if (jsonString != null) {
                try {
                    ...
                    for (int i = 0; i < results.length(); i++) {
                        ...
                        String galleryLocation = html.substring(p_start_index + "<p>".length(), p_end_index);
                        ...
                        String galleryUrl = html.substring(href_start_index + "<a href=\"".length(), href_end_index);
